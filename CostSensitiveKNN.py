...
class ID3ContinuousFeatures(object):
    ...
    def _tdidt_algorithm(examples: Examples, features: Features, default: int,
        ...
        subtrees = [ID3ContinuousFeatures._tdidt_algorithm(examples, # TODO: was np.delete
                                                           features,  # TODO: do I need features?
                                                           majority_class,
                                                           select_feature, M),

                    ID3ContinuousFeatures._tdidt_algorithm(examples, # TODO: was np.delete
                                                           features,
                                                           majority_class,
                                                           select_feature, M)]
    ...
    @staticmethod
    def _max_ig_continuous_features(examples: Examples) -> Tuple[int, Examples, Examples]:
    ...
    @staticmethod
    def _dynamic_partition(feature: np.array) -> Examples:
        return ()
...
def pruning_test():
    ...
    print(ID3ContinuousFeatures.classify_without_pruning("./test_csv/train.csv", "./test_csv/test.csv"))
    print(ID3ContinuousFeatures.classify_with_pruning("./test_csv/train.csv", "./test_csv/test.csv"))
